...
OBJS = kernel_entry.o idt.o irq1.o screen.o keyboard.o ports.o kernel.o idt_load.o irq0.o fat12.o

all: os-image.bin

fat12.o: fat12.c fat12.h ports.h screen.h
	$(CC) $(CFLAGS) -c fat12.c -o $@
